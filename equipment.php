...
if (isset($_GET['article']) && isset($_GET['cat']) && isset($_GET['subcat']))
{
	...
	{
		echo "<div style='float:right;'><a href='admin.php?act=app_article&id=$article->id'>Редактировать</a></div>\n ";
	}
...
elseif (isset($_GET['cat']) && isset($_GET['subcat']))
{
	...
	while ($article->one() == true)
	{
		if ($article->active == 'on')
		{
			...
			echo "
				<tr class='row$odd'>
					<td class='t-auth'><a href='" . $cat->url . $subcat->url . $article->url . "'>$article->icon</a></td>
					<td class='t-post'>
...
elseif (isset($_GET['cat']))
{
	...
	while ($subcat->one() == true)
	{
		...
		if ($subcat->active == 'on')
		{
			...
			echo "
				<tr class='row$odd'>
					<td class='t-auth'><a href='$cat->url$subcat->url'>$subcat->icon</a></td>
					<td class='t-post'>
