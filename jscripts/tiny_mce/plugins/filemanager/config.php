<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../content/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../content/'; // absolute or relative from this script path.
