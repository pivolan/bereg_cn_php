...
<?endif;?>
    ...
    <tr class='row1'>
      <td colspan="2" class='t-post'>
        <textarea id="ta" name="text" style="width: 100%; height: 400px;" onchange="documentDirty=true;"><?=$article->text;?></textarea>
      </td>
    </tr>
  </tbody>
</table>
...
<script type="text/javascript">
        tinyMCE.init({
                ...
                height : "400",
                document_base_url : "/",
                plugins : "imagemanager,filemanager,style,advimage,advlink,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking,xhtmlxtras,visualchars,media,table",
                elements:"ta",
                // Theme options
